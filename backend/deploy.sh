...
# =====================
EC2_USER="ubuntu"
EC2_HOST="ec2-13-203-155-78.ap-south-1.compute.amazonaws.com"  # ✅ NEW SERVER
EC2_PATH="/var/www/gitasarathi.hiteshbuilds.com/"
LOCAL_DIST="dist"
...
# SSH Key Locations
SSH_KEYS=(
"/Users/hitesh/local/keys/aws/cloudgeeksaws.pem"  # ✅ UPDATED KEY
"/home/hitesh-patel/Dev/keys/aws/cloudgeeksaws.pem"
)
